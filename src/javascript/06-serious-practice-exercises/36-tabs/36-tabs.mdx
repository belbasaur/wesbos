...
In this example we will practice showing/hiding things, event listeners, looping, and we will learn how to make it accessible.

The user should be able to use their keyboard to move between tabs without touching their mouse.
...
You will notice a lot of role and aria labels in the HTML and that is important because it is how you make your tabs accessible to everyone and search engines can easily read it.
...
Now you need to find the associated tab panel.
